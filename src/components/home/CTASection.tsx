...
export default function CTASection() {
  return (
    <section className="py-24 lg:py-32 bg-gradient-to-br from-navy-800 via-navy-700 to-navy-600 relative overflow-hidden">
      <div className="absolute inset-0 grid-pattern opacity-10" />
      <div className="absolute -top-1/2 -right-1/4 w-[800px] h-[800px] bg-accent-blue/5 rounded-full blur-3xl" />
      <div className="absolute -bottom-1/2 -left-1/4 w-[600px] h-[600px] bg-accent-gold/5 rounded-full blur-3xl" />
