      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4 items-center">
            ...
            <button onClick={() => { localStorage.removeItem('admin_token'); localStorage.removeItem('admin_name'); window.location.href = '/admin'; }} className="px-4 py-2 rounded-xl bg-white border border-steel-200 text-steel-600 text-sm font-medium hover:bg-steel-50 transition-colors ml-2">
              Logout
            </button>
          </div>
        </div>
