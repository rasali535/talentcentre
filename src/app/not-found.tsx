...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-navy-800 via-navy-700 to-navy-600 flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full text-center relative z-10">
        <div className="w-20 h-20 rounded-2xl bg-white shadow-premium flex items-center justify-center mx-auto mb-8 relative">
          ...
          <div className="absolute -top-2 -right-2 w-4 h-4 bg-accent-gold rounded-full animate-ping" />
        </div>
        
        <h1 className="text-3xl font-heading font-bold text-navy-700 mb-4">
          Page Not Found
        </h1>
